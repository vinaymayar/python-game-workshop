...
print("abc" < "bca")
print("abc" > "bca")
# When comparing strings, the operators check the alpahbetical order.
...
print(not not True) # evaluates to True
...
# The else block will be executed when the if statements condition is False.
